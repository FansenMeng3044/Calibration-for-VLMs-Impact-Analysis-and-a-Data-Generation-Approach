# =============================================================================
# 【原脚本 / 旧】使用 CC3M 做 calibration 的剪枝流程
# 文件名标注: ecoflap_zeroth_cc3m_calibration.py
# 用法: python ecoflap_zeroth_cc3m_calibration.py <GPU> <port>
# 对应配置: lavis/projects/blip2/eval/cc_prefix_derivative_compute_cc3m.yaml
# =============================================================================
import subprocess
import random
...
f" --cfg-path lavis/projects/blip2/eval/cc_prefix_derivative_compute_cc3m.yaml"
