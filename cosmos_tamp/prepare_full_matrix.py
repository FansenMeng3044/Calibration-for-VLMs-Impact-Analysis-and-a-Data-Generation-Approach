#!/usr/bin/env python3
"""Create a resumable Cosmos TAMP 6-pruning/21-evaluation task queue."""
...
def main() -> int:
    ...
    if not args.ar_sparsity <= args.max_sparsity_per_linear < 1.0:
        raise ValueError("--max-sparsity-per-linear must be >= AR sparsity and < 1")
    ...
    manifest = {
        ...
        "joint_variant": "joint_multimodal_reasoner_ar",
        "separate_variant": "separate_text_only_reasoner_ar",
        "vision_sparsity": 0.0,
        ...
        "calibration_policy_note": (
            ...
            "No labels are consumed during TAMP importance statistics."
        ),
    }
