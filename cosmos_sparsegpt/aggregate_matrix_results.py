#!/usr/bin/env python3
"""Aggregate validated dense and 6x3 pruned Cosmos evaluation results."""
...
def main() -> int:
    ...
    csv_path = output_dir / "cosmos_sparsegpt_6x3_plus_dense.csv"
    with csv_path.open("w", encoding="utf-8", newline="") as handle:
        writer = csv.DictWriter(handle, fieldnames=list(rows[0]))
        writer.writeheader()
        writer.writerows(rows)
    json_path = output_dir / "cosmos_sparsegpt_6x3_plus_dense.json"
