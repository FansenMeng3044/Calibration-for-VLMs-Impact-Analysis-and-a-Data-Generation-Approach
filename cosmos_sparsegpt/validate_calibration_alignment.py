...
def main() -> int:
    ...
    for name in ("mmbench", "mmmu", "okvqa"):
        ...
        joint = sparsegpt.build_calibration_records(
        ...
        vision = sparsegpt.build_calibration_records(
        ...
        ar = sparsegpt.build_calibration_records(
        ...
        joint_text = [sparsegpt.normalized_pair_text(record.text) for record in joint]
        vision_text = [sparsegpt.normalized_pair_text(record.text) for record in vision]
        ar_text = [sparsegpt.normalized_pair_text(record.text) for record in ar]
