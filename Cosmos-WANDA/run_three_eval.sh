...
ROOT="${ROOT:-/private/workspace/hycui/mfs/cosmos_wanda}"
...
case "${TASK_SELECTION}" in
  all) TASKS="mmbench_en_dev_local,mmmu_val_local,okvqa_val2014_local" ;;
  mmbench) TASKS="mmbench_en_dev_local" ;;
  mmmu) TASKS="mmmu_val_local" ;;
  okvqa) TASKS="okvqa_val2014_local" ;;
  *)
