#!/usr/bin/env python3
"""Aggregate validated dense and 6x3 pruned Cosmos ATV results."""
...
def main() -> int:
    ...
    for model_id in MODELS:
        ...
        for benchmark in BENCHMARKS:
            ...
            row = {
                ...
                "alpha": None if checkpoint_metadata is None else checkpoint_metadata["alpha"],
                "target_ar_sparsity": (
    ...
    csv_path = output_dir / "cosmos_atv_6x3_plus_dense.csv"
    with csv_path.open("w", encoding="utf-8", newline="") as handle:
        writer = csv.DictWriter(handle, fieldnames=list(rows[0]))
        writer.writeheader()
        writer.writerows(rows)
    json_path = output_dir / "cosmos_atv_6x3_plus_dense.json"
